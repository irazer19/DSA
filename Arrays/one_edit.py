...
Brute force:
The brute force approach would be to try all possible edit operations (insert, delete, replace) at every position and
check if we can transform one string into another with exactly one operation.
